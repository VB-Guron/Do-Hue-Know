...
def calc_Yellow():
    ...
    y1, sr1 = librosa.load('D:/Unity Projects/ThesisClone - Copy/Assets/Final_DTW_Thesis/girl_voicelines/07.Amplified/Yellow.wav',sr=44100)  # Color library
    y2, sr2 = librosa.load('D:/Unity Projects/ThesisClone - Copy/Assets/Final_DTW_Thesis/VoiceInput.wav', sr=44000)  # Put the unity voice-line file here
