...
def calc_Yellow():
    ...
    file_to_open = data_folder / "Yellow.wav"
    ...
    y1, sr1 = librosa.load(file_to_open,sr=44100)  # Color library
    y2, sr2 = librosa.load('VoiceInput.wav', sr=44000)  # Put the unity voice-line file here
